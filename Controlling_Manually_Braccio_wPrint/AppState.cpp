...
void printAngles(const char* angleFor, float position) {
  Serial.print(angleFor); Serial.println(position);
}
...
State * ShoulderState::handle_OnUp()
{
  ...
  printAngles("Shoulder: ", shoulder.position());
  return this;
}
...
State * ShoulderState::handle_OnLeft()
{
  ...
  printAngles("Base: ", base.position());
  return this;
}
...
State * ElbowState::handle_OnUp()
{
  ...
  printAngles("Elbow: ", elbow.position());
  return this;
}
...
State * WristState::handle_OnUp()
{
  ...
  printAngles("Wrist Pitch: ", wristPitch.position());
  return this;
}
...
State * WristState::handle_OnLeft()
{
  ...
  printAngles("Wrist Roll: ", wristRoll.position());
  return this;
}
...
State * PinchState::handle_OnLeft()
{
  ...
  printAngles("Gripper: ", gripper.position());
  return this;
}
